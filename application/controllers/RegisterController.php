	...
	public function register()
	{
		...
		if ($dbResult->proc == 'true') {
			...
			if ($this->BasicQuery->insert('detail_user', array(	'id' => 'detailuser_'.date('Ymdhisa'),
				...
				$body = "<br>Dear ".$dbResult->data['fullname']."<br><br><br>Thank you for registering at Research-Academy org. We are very pleased to welcome you to our learning platform.<br><br>Please note your<br>Username: ".$dbResult->data["username"]."<br>Password: ".$dataReceived["password"]."<br><br>Which you can use as a one key to all events and courses this platform offers.<br><br>Feel free to explore our events, courses and publications.  <br><br>If you wish to be one of our research-academy org instructor, please contact us at info@research-academy org<br><br><br>Yours Sincerely,<br>Research-academy org";
