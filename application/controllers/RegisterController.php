	...
	public function register()
	{
		...
		if ($dbResult->proc == 'true') {
			...
			if ($this->BasicQuery->insert('detail_user', array(	'id' => 'detailuser_'.date('Ymdhisa'),
				...
				$body = "Dear ".$dbResult->data['fullname']."Thank you for registering at Research-Academy.org. We are very pleased to welcome you to our learning platform.Please note yourUsername: ".$dbResult->data["username"]."Password: ".$dataReceived["password"]."Which you can use as a one key to all events and courses this platform offers.Feel free to explore our events, courses and publications.  If you wish to be one of our research-academy.org instructor, please contact us at info@research-academy.orgYours Sincerely,Research-academy.org";
