...
<head>
	...
	<link rel="stylesheet" href="<?php echo base_url();?>theme/campus/css/bootstrap.css">
	<!-- include the site stylesheet -->
	<link rel="stylesheet" href="<?php echo base_url();?>theme/campus/css/plugins.css">
	<!-- include the site stylesheet -->
	<link rel="stylesheet" href="<?php echo base_url();?>theme/campus/css/colors.css">
	<!-- include the site stylesheet -->
	<link rel="stylesheet" href="style.css">
	<!-- include the site responsive stylesheet -->
	<link rel="stylesheet" href="<?php echo base_url();?>theme/campus/css/responsive.css">
</head>
<body>
	...
	<div id="wrapper">
				...
				<div class="container">
					<div class="row">
						<div class="col-xs-6 col-sm-3">
							...
							<div class="logo">
								<a href="home.html">
									<img class="hidden-xs" src="<?php echo base_url();?>theme/campus/images/logo.png" alt="studylms">
									<img class="hidden-sm hidden-md hidden-lg" src="<?php echo base_url();?>theme/campus/images/logo-dark.png" alt="studylms">
								</a>
							</div>
						</div>
		...
		<div id="loader" class="loader-holder">
			<div class="block"><img src="<?php echo base_url();?>theme/campus/images/svg/hearts.svg" width="100" alt="loader"></div>
		</div>
	</div>
	...
	<!-- include jQuery -->
	<script src="<?php echo base_url();?>theme/campus/js/jquery.js"></script>
	<!-- include jQuery -->
	<script src="<?php echo base_url();?>theme/campus/js/plugins.js"></script>
	<!-- include jQuery -->
	<script src="<?php echo base_url();?>theme/campus/js/jquery.main.js"></script>
	<!-- include jQuery -->
	<script type="text/javascript" src="<?php echo base_url();?>theme/campus/js/init.js"></script>
</body>
</html>